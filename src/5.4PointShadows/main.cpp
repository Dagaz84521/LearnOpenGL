...
int main()
{
    GLFWwindow* window = initializeGLFW("Point Shadows");
    if (window == nullptr) {
    ...
    // 着色器
    Shader simpleDepth("Shader/5.4PointShadows/SimpleDepthShader.vs", "Shader/5.4PointShadows/SimpleDepthShader.fs", "Shader/5.4PointShadows/SimpleDepthShader.gs");
    Shader pointShadow("Shader/5.4PointShadows/PointShadow.vs", "Shader/5.4PointShadows/PointShadow.fs");
    Shader LightCube("Shader/5.4PointShadows/LightCube.vs", "Shader/5.4PointShadows/LightCube.fs");

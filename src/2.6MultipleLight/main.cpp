...
int main()
{
    ...
    Shader lightingShader("Shader/2.6MultipleLight/multiple_light.vs", "Shader/2.6MultipleLight/multiple_light.fs");
    Shader lightCubeShader("Shader/2.6MultipleLight/light_cube.vs", "Shader/2.6MultipleLight/light_cube.fs");

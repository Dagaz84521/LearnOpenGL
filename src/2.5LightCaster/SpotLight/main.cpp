...
int main()
{
    ...
    Shader lightingShader("Shader/2.5LightCaster/SpotLight/SpotLight.vs", "Shader/2.5LightCaster/SpotLight/SpotLight.fs");
    Shader lightCubeShader("Shader/2.5LightCaster/SpotLight/light_cube.vs", "Shader/2.5LightCaster/SpotLight/light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // model = glm::scale(model, glm::vec3(0.2f)); // 变小
